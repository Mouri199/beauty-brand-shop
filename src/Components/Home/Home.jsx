        ...
        <div>
            ...
            <div className="lg:flex gap-32 items-center bg-[#a5c7b5] lg:px-32 lg:py-10">
                <div className="lg:w-[800px]">
                    <h3 className="lg:text-5xl text-3xl font-semibold text-[#3b644c] mb-8">Everything
                        You Need to Create a Beauty Website</h3>
                    <p className="lg:text-3xl text-xl text-[#3b644c] mb-5">Beautifo offers stunning beauty designs and layouts for cosmetics shop, make up and beauty spa with multiple styles.</p>
                    <button className="btn bg-[#3b644c] text-white">SHOP NOW</button>
                </div>
                <div>
