        ...
        <div>
            <div className="flex justify-evenly py-44 items-center">
                <div>
                    ...
                    <div className="absolute lg:left-[500px] lg:top-[1000px]">
                        <img src="https://i.ibb.co/qkfJ8xT/cosmetology-and-professional-skin-care-2022-03-01-10-18-13-utc.jpg" alt="" />
                    </div>
                </div>
