    ...
    return (
        <div>
            <div className="lg:flex lg:px-0 px-5 lg:py-0 py-5 bg-[#a5c7b5] justify-center gap-20 items-center">
                <div className="">
                    <h3 className="lg:text-5xl  text-center text-2xl lg:w-[500px] font-bold mb-5">Glow Your <span className="text-[#3b644c]"> Face & Vitality </span> With Our Best Service</h3>
